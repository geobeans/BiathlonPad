...
public abstract class BaseActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback,ModuleUtil.CallBackInterface {
    public static float FLT_EPSILON = 0.00001f;
    ...
    protected SimpleDateFormat dateformat1 = new SimpleDateFormat("MM-dd-yyyy");
    protected Float m_fQiwen = 0.0f;
    protected Float m_fQiya = 0.0f;

    protected Long tempSeq = -1L;
    protected Long tempIndex = -1L;
